...
<body>
	<div class="topnav" id="myTopnav">
		<a href="/" id="logo" target="_blank"><img src="/img/logo.png"
			...
			class="active">About Us</a> <a href="/checking">Checking</a> <a href="/savings">Savings</a>
		<a href="/invest">Investments</a> <a href="/newUser">Sign Up</a> <a
			href="/showUser" class="login">Login</a>
	...
	<div class="row">
		<div class="col-12 col-s-12">
			<div class="header" style="text-align: center; font-size: 20px">
				<h1>Meet Team 3!</h1>
				<p>
					We created this mock online banking website for a group project. <br>
					[4-weeks of working hard or hardly working] <br>Please visit
					our profiles on GitHub & LinkedIn! <br> <i
			...
			<div class="card">
				...
				<h1>Reza</h1>
				<p class="title">Developer</p>
				<a href="https://github.com/rzjrh"><i class="fab fa-github-alt"></i></a>
				<a href="https://www.linkedin.com/in/reza-akhlaqi/"><i
					class="fab fa-linkedin"></i></a>
