...
<jsp:include page="includes/header.jsp" />
    ...
    <div class="col-3 col-s-12">
            <div class="login-form">
                ...
                <br>
                <p>Don't have an account? <span class="enroll"><a href="/register">Enroll Today!</a></span></p>
            </div>
        </div>
        <div class="dots col-9 col-s-10">
            <h1 style="text-align:center">Welcome to Merit America Online Bank!</h1>
